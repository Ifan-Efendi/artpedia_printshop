        ...
        <div class="col-12">
            <div class="card shadow-sm order-builder">
                <div class="card-body p-4">
                    <form action="{{ route('pelanggan.cart.add') }}" method="POST" enctype="multipart/form-data" id="orderForm">
                        @csrf

                        <div class="alert alert-info mb-4">
                            <span class="order-meta mb-0 d-block">Setelah produk ditambahkan, lanjutkan checkout di keranjang pesanan.</span>
                        </div>
                                ...
                                <div id="options-section" style="display: none;">
                                    ...
                                    <div class="extras-box">
                                        ...
                                        <div class="mb-3" id="finishing-group">
                                            ...
                                            <div class="option-grid equal-size">
                                                <label class="position-relative">
                                                    <input class="option-chip-input finishing-opt" type="radio" name="finishing" id="finishing_none" value="" checked>
                                                    <span class="option-chip">Tidak Ada</span>
                                                </label>
                                                <label class="position-relative">
                                                    <input class="option-chip-input finishing-opt" type="radio" name="finishing" id="finishing_glossy" value="Glossy" data-harga="4000">
                                                    <span class="option-chip">Laminasi Glossy (+Rp 4.000)</span>
                                                </label>
                                                <label class="position-relative">
                                                    <input class="option-chip-input finishing-opt" type="radio" name="finishing" id="finishing_doff" value="Doff" data-harga="4000">
                                        ...
                                        <div class="mb-3" id="cutting-group" style="display: none;">
                                            ...
                                            <div class="option-grid equal-size">
                                                <label class="position-relative">
                                                    <input class="option-chip-input cutting-opt" type="radio" name="opsi_potong" id="potong_kiss" value="Kiss Cut" data-harga="4000">
                                                    <span class="option-chip">Kiss Cut (+Rp 4.000)</span>
                                                </label>
                                                <label class="position-relative">
                                                    <input class="option-chip-input cutting-opt" type="radio" name="opsi_potong" id="potong_die" value="Die Cut" data-harga="8000">
...
<script>
    ...
    @if(isset($selectedProduk) && $selectedProduk)
        const selectedKategoriId = "{{ $selectedProduk->kategori_id }}";
        const selectedProdukId = "{{ $selectedProduk->id }}";
        kategoriSelect.value = selectedKategoriId;
        fillProdukByKategori(selectedKategoriId);
        produkSelect.value = selectedProdukId;
