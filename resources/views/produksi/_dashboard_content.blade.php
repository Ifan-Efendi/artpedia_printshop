            ...
            <div class="card-body">
                @if($sedangDiproses)
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            <h4 class="fw-bold mb-1">{{ $sedangDiproses->produk->nama }}</h4>
                            <code class="fs-6">{{ $sedangDiproses->nomor_pesanan }}</code>
                        </div>
                    </div>
                    ...
                    <div class="bg-light rounded p-3 mb-4">
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                ...
                                <strong class="fs-5">{{ $sedangDiproses->jumlah }} {{ $sedangDiproses->produk->unit_label ?? 'lembar' }}</strong>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="d-grid gap-2">
                        @if($sedangDiproses->file_desain && $sedangDiproses->file_desain !== 'NANTI_DIKIRIM')
