...
@section('content')
    <div class="page-header">
        <div class="d-flex align-items-center gap-3 mb-1">
            ...
            <div>
                <h1 class="fw-bold" style="color: #9d005e;">Tambah Kategori Baru</h1>
                <p class="text-muted">Isi data kategori produk yang ingin ditambahkan.</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama" id="nama"
                                       ...
                                       value="{{ old('nama') }}" placeholder="Contoh: Flyer, ID Card, dll." required>
                                @error('nama')
